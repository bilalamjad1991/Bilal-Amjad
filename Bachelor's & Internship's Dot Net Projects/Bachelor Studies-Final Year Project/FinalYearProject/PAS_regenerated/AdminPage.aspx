<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="PAS_regenerated.AdminPage" %>
				...
				<section class="cols">
					<div> <%--class="col"--%>
						...
						<p style="color:#F2F2F2">test</p>
                         ...
                         <asp:Button ID="btnUpdateMedicine" runat="server" Text="Update Medicine stock" 
            Height="54px" Width="612px" Font-Bold="True" 
            onclick="btnUpdateMedicine_Click" />
        <br /><br />
        <asp:Button ID="btnAddNewMedicine" runat="server" Text="Add New Medicine " 
            Height="54px" Width="612px" Font-Bold="True" 
            onclick="btnAddNewMedicine_Click" />
        <br /><br />
        <asp:Button ID="btnAttendanceCheck" runat="server" Text="Check Attendance" 
            Height="54px" Width="612px" Font-Bold="True" 
            onclick="btnAttendanceCheck_Click" />
         <br /><br />
                  <asp:Button ID="btnEmployeeProfile" runat="server" Text="Employee Profile"  
                   Height="54px" Width="612px" Font-Bold="True" onclick="btnEmployeeProfile_Click" />
