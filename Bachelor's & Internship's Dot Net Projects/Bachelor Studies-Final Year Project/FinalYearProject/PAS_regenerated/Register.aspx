<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="PAS_regenerated.Register" %>
...
<head id="Head1" runat="server">
	...
	<script src="js/functions.js" type="text/javascript"></script>
      ...
      <script type="text/javascript">
          function HideLabel() {
              document.getElementById('<%= lbluserStatus.ClientID %>').style.display = "none";
      ...
      <script type="text/javascript">
          function HideLabel1() {
              document.getElementById('<%= rgstr_msglbl.ClientID %>').style.display = "none";


          }
          setTimeout("HideLabel1();", 2500);
    </script>
      ...
      <li style="font-size: 10px"> <asp:LinkButton ID="lnkbtnSignout" runat="server" 
		...
		<div class="shell">
          ...
          <table>
                ...
                <tr>
                        <td>
                            <asp:TextBox ID="txtFirstName" runat="server" ToolTip="Enter First Name" Height="32px" Width="208px"></asp:TextBox>
                        </td>
                ...
                <tr>
                        <td>
                            <asp:TextBox ID="txtLastName" runat="server" ToolTip="Enter Last Name" Height="32px" Width="208px"></asp:TextBox>
                        </td>
                ...
                <tr>
                    <td class="lable"> 
                        <asp:Label Height="25px" Width="100px" ID="txtUserName1" 
                            runat="server" Text="User Name:" Font-Size="Medium" Font-Bold="True" 
                            ForeColor="Black"></asp:Label> </td>
                </tr>
                <tr> 
                   <td>  <asp:TextBox ID="txtUser" runat="server" ToolTip="Enter User Name" Height="32px" Width="208px"></asp:TextBox></td>
       <%--            <td>
                        <asp:RequiredFieldValidator ID="rfvUserName" runat="server" ControlToValidate="txtUser" CssClass="failureNotification"
                ...
                <tr>
                        <td>
                            <asp:Button ID="btnCheckUsername" runat="server" Text="Check availability" 
                                Font-Bold="True" onclick="btnCheckUsername_Click" />
                        </td>
                        <td>
                            <asp:Label ID="lbluserStatus" runat="server" Visible="False" Font-Bold="True" 
                ...
                <tr>
                    <td> <asp:TextBox ID="txtPhone" runat="server" ToolTip="Please Enter Your Mobile Number" Height="32px" Width="208px"></asp:TextBox> </td>
      <%--              <td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:TextBox ID="txtEmail" runat="server" ToolTip="Enter you Email " Height="32px" Width="208px"></asp:TextBox>
                    </td>
    <%--                <td>
                ...
                <tr>
                    <td> <asp:TextBox ID="txtAddress" runat="server" ToolTip="Enter Your Residential Address " Height="32px" Width="208px"></asp:TextBox></td>
                    <td>
                ...
                <tr>
                    <td>
                         <asp:TextBox ID="txtDOB" runat="server" TextMode="SingleLine" ToolTip="DOB Fromat:MM/DD/YYYY" Height="32px" Width="208px"></asp:TextBox>                       
                    </td>
                    <td>
                    <asp:RangeValidator ID="RangeValidator1" ControlToValidate="txtDOB" CssClass="failureNotification" MinimumValue="12/31/1989" MaximumValue="1/1/2100" Text="Date format :MM/DD/YYYY" Display="Dynamic" Type="Date" runat="server"
                     ...
                     <tr>
                            <td>
                                 <asp:Button ID="btnCancel" runat="server" 
                                      Height="33px" Text="Cancel" Width="78px" onclick="btnCancel_Click" />
                           

                         
                             <asp:Button ID="btnRegister" Text="Register" runat="server" Height="33" Width="78" 
