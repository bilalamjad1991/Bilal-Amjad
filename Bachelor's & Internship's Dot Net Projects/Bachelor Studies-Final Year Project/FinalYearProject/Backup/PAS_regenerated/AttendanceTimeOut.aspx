<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceTimeOut.aspx.cs" Inherits="PAS_regenerated.AttendanceTimeOut" %>
...
<head id="Head1" runat="server">
	<meta charset="utf-8" />
	<title>Attendance Time Out</title>
	...
	<script src="js/functions.js" type="text/javascript"></script>
     ...
     <script type="text/javascript">
         function HideLabel() {
             document.getElementById('<%= lblTimeout1.ClientID %>').style.display = "none";
			...
			<div class="main">
				<section class="cols">
					<div> <%--class="col"--%>
                        ...
                        <asp:Label ID="lblEmpId" runat="server" Text="Employee ID :" Font-Bold="True" 
            ForeColor="Black"></asp:Label>
        <asp:TextBox ID="txtEmpId" runat="server"></asp:TextBox>
           
        <asp:Button ID="btnSaveTimeOut" runat="server" Text="Save Attendance"  
            Font-Bold="True" onclick="btnSaveTimeOut_Click" />
        <br />
         <asp:Label ID="lblTimeout1" runat="server" Visible="False" ForeColor="Red" 
            Font-Bold="True"></asp:Label>
         <br />
        <asp:Label ID="lblCurrentDate" runat="server" Text="Current Date & Time :" Font-Bold="True" ForeColor="Black"></asp:Label>
        <asp:Label ID="lblDate1" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
       
        <asp:Label ID="lblDates" runat="server" Visible="False"></asp:Label>
