...
Public Class DailyOutwardReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GPMS.DailyOutwardReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyOutwardReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyOutwardReport = New DailyOutwardReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
