Public Class frmIndentFind
    ...
    Sub FillGrid()
        ...
        Grid.DataSource = D.GetDataTable("Select * from vwIndents")
        Grid.Refresh()
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        Dim S As String
        Me.Cursor = Cursors.WaitCursor
        S = "Select * from vwIndents WHERE  [Indent No] + Department + Section + [Demand By] + [Store In-Charge] + Status like '%" & txtFind.Text & "%'" & IIf(dtDate.Checked, " AND convert(varchar(10),[Date],105) ='" & Format(dtDate.Value, "dd-MM-yyyy") & "'", "")
