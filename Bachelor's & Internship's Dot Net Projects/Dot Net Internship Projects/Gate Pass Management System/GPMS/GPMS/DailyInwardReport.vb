...
Public Class DailyInwardReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GPMS.DailyInwardReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyInwardReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyInwardReport = New DailyInwardReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
