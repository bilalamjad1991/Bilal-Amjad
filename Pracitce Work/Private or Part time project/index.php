...
<body>
	...
	<br>
		<table class="table">
			...
			<!-- This code is sending product's name,price & quantity to insertCart.php file to save them in a Session -->
			<form action="insertCart.php" method="post">
				<tbody>
					...
					<tr>
						<td>Quantity</td>
						<td><input id ="cartQtyTextbox" type="text" name="qty" class="form-control col-lg-6"></td>
							<input type="hidden" name="name" value="Shirt">
							<input type="hidden" name="price" value="1000">
						<td><input type="submit" value="Add to Cart" name="addCart" class="btn btn-primary" onclick="addCartFunction()"></td>
					</tr>
				</tbody>
			</form>
		</table>
