...
var accountTests = []struct {
	...
	{
		Transaction{Op: Transfer, Amount: 500,  TransferTo: Account{Number: accountNum2, Balance: 0}},
		TransactionResult{
			AccountNum: accountNum,
			Balance:    1000,
			TransferTo: Account{Number: accountNum2, Balance: 500},
			TransferAmount: 500,
		},
	},
